...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #3552A6 !important; border-bottom: 2px solid white !important;">
        ...
        <div class="row justify-content-center">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="./crearcuenta.php" style="text-decoration: none !important; color: #212529BF !important;">Crear Cuenta</a></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="margenpri estirarcontent accordion container-fluid1 container-fluid" id="accordionExample" style="--bs-accordion-active-bg: #3552A6 !important; --bs-accordion-btn-focus-box-shadow: #ffffff !important; --bs-accordion-active-color: #ffffff !important; --bs-accordion-btn-color-active: #ffffff !important;">
