        ...
        <div class="row justify-content-center">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="./inscripciones.php" style="text-decoration: none !important; color: #212529BF !important;">Inscripciones</a></li>
                    </ol>
                </nav>
            </div>
        </div>
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 pad-abajo">
                    <h5>¿Quiénes somos?</h5>
                    <p>SLearn4You, una pagina dedicada a la organización de eventos y servicios deportivos. Nuestra misión es facilitar la planificación y gestión de actividades deportivas para individuos y organizaciones.</p>
                </div>
                <div class="col-sm-4 pad-abajo">
                    <h5>Links Rápidos</h5>
                    <ul>
