          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 pad-abajo">
                    <h5>¿Quiénes somos?</h5>
                    <p>Learn4You, nua pagina dedicada a la organización de eventos y servicios deportivos. Nuestra misión es facilitar la planificación y gestión de actividades deportivas para individuos y organizaciones.</p>
                </div>
                <div class="col-sm-4 pad-abajo">
                    <h5>Links Rápidos</h5>
                    <ul>
