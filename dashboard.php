...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var categorias = [
                { nombre: 'Taquilleros', descripcion: 'Crea tu cuenta personalizada paso a paso para acceder a todas nuestras funciones.', link: './taquilleros.php' },
                { nombre: 'Administradores', descripcion: 'Guía paso a paso para comenzar tu viaje con nosotros.', link: './administradores.php' }
            ];
